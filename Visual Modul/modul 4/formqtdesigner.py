...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.lineEdit_2.setGeometry(QtCore.QRect(110, 70, 241, 20))
        self.lineEdit_2.setObjectName("lineEdit_2")
        self.pushButton = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton.setGeometry(QtCore.QRect(110, 110, 101, 51))
        self.pushButton.setAutoFillBackground(False)
        self.pushButton.setStyleSheet("QPushButton {\n"
"    background-color: rgb(123, 255, 67); /* Warna latar belakang */\n"
"    color: black;            /* Warna teks */\n"
"    border-radius: 5px;      /* Membuat sudut melengkung */\n"
"    border: 1px solid #2980b9; /* Garis tepi */\n"
"}")
        self.pushButton.setObjectName("pushButton")
        self.pushButton_2 = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_2.setGeometry(QtCore.QRect(250, 110, 101, 51))
